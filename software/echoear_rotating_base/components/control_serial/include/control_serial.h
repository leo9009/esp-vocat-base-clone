...
#define MAGNETIC_ATTACH_STATUS_ATTACHED     (0x0001)    /**< EchoEar attached to base */
#define MAGNETIC_ATTACH_STATUS_DETACHED     (0x0000)    /**< EchoEar detached from base */
 ...
 * 
 * @note This task periodically checks if EchoEar is magnetically attached to the base
