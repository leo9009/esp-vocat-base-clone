...
> 💡 **配套主机端工程**：若想体验完整的磁吸交互，请参考 esp-vocat 主机端的配套 UI 动画演示仓库：[ESP-VoCat 磁吸滑块 UI 演示 (Gitee)](https://gitee.com/esp-friends/esp-echo-ear-xiaozhi/tree/feat%2Fadd_mag_slide_switch_demo/)
...
- [**磁吸底座硬件开源地址**](https://oshwhub.com/esp-college/esp-echoear-base)
- [**ESP-VoCat 喵伴开源硬件链接**](https://oshwhub.com/esp-college/echoear)
